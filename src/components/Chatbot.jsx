    ...
    <>
      <div className="my-20 bg-linear-to-r/hsl from-[#103571] to-[#014FCD]">
        <Container className="py-10">
          <div className="mb-15">
            <h4 className="font-Questrial font-normal text-lg sm:text-2xl leading-4.5 sm:leading-6 tracking-tighter text-[#FCE38A]">Live Ai Coach</h4>
            <h2 className="mt-5 font-Questrial font-normal text-3xl sm:text-5xl md:text-6xl leading-11 sm:leading-18 tracking-tighter text-white">Take a Suggestion Coaching</h2>
          </div>
            ...
            <div className="lg:w-[63%] mb-6 lg:mr-4 xl:mr-6 flex flex-col sm:flex-row items-center">
              <div className="w-full sm:w-175 xl:w-201 sm:mr-4 xl:mr-6 overflow-hidden rounded-xl border border-[#CDCDCD]">
                ...
                <div className="pt-4 pb-6 bg-white">
                  <h3 className="ml-8 font-Manrope font-bold text-lg leading-5.5 text-[#1B1B1B]">AI Sales Coach</h3>
                </div>
                {/* Chatbot Body */}
                  ...
                  <Flex className="flex-col justify-between gap-4">
                    <Flex className="justify-start">
                      ...
                      <div className="max-w-[80%] ml-5 py-2 px-6 rounded-lg bg-white">
                        <p className="font-Poppins font-normal text-sm lg:text-[15px] leading-6 text-[#181818]">Hello! I'm your AI sales coach. How can I help you improve your sales performance today?</p>
                      </div>
                    </Flex>
