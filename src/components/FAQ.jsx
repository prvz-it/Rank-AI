  ...
  return (
    <>
      <Container className="my-20">
        ...
        <div className="mt-15">
            <div className="pt-3 pb-40 sm:pb-22 border-y border-[#cccccc] lg:pb-18 xl:pb-12 flex items-center justify-between">
                <div className="flex items-center">
                    <div>
                        <h4 className="font-Questrial font-normal text-base sm:text-2xl leading-6 tracking-[-1%] text-[#8B7D4C]">01</h4>
                    </div>
                    <div className="w-79 sm:w-148 md:w-2xl lg:w-4xl xl:w-5xl ml-1 sm:ml-3 lg:ml-6 xl:ml-10 relative">
                ...
                <div className="cursor-pointer mr-2" onClick={() => {setView1(!view1)}}>
                    {view1 == true ? <FaPlus /> : <FaMinus />}
                </div>
            </div>
            <div className="pt-3 pb-40 sm:pb-22 lg:pb-18 xl:pb-12 flex items-center justify-between">
                <div className="flex items-center">
                    <div>
                ...
                <div className="cursor-pointer mr-2" onClick={() => {setView2(!view2)}}>
            ...
            <div className="pt-3 pb-40 sm:pb-22 border-y border-[#cccccc] lg:pb-18 xl:pb-12 flex items-center justify-between">
                ...
                <div className="cursor-pointer mr-2" onClick={() => {setView3(!view3)}}>
